...
var loadDependencies = function () { return Promise.all([
    $.get("".concat(basePath, "/testData.js")),
    $.get("".concat(basePath, "/storage.js")),
    $.get("".concat(basePath, "/inventoryStore.js"))
]); };
var loadPages = function () { return Promise.all([
    $.get("".concat(basePath, "/pages/addItem.js")),
    $.get("".concat(basePath, "/pages/inventory.js"))
]); };
